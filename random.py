...
\033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m??\033[1;95m??\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
   ...
   \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
   ║  \x1b[97m\033[37;41m  ASKED YOU PAPA HWO I AM RAJU   \033[0;m   \33[1;92m    ║
   \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝        """)    
...
jalan('\x1b[1;31mRAJU CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :RAJU = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :RAJU = ' √ 2009'
        elif uid[:8] in ['10000000']        :RAJU = ' √ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:RAJU = ' √ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:RAJU = ' 2010'
        elif uid[:6] in ['100001']          :RAJU = ' √ 2010/2011'
        elif uid[:6] in ['100002','100003'] :RAJU = ' √ 2011/2012'
        elif uid[:6] in ['100004']          :RAJU = ' √ 2012/2013'
        elif uid[:6] in ['100005','100006'] :RAJU = ' √ 2013/2014'
        elif uid[:6] in ['100007','100008'] :RAJU = ' √ 2014/2015'
        elif uid[:6] in ['100009']          :RAJU = ' √ 2015'
        elif uid[:5] in ['10001']           :RAJU = ' √ 2015/2016'
        elif uid[:5] in ['10002']           :RAJU = ' √ 2016/2017'
        elif uid[:5] in ['10003']           :RAJU = ' √ 2018/2019'
        elif uid[:5] in ['10004']           :RAJU = ' √ 2019/2020'
        elif uid[:5] in ['10005']           :RAJU = ' √ 2020'
        elif uid[:5] in ['10006','10007','']:RAJU = ' √ 2021'
        elif uid[:5] in ['10008']           :RAJU = ' √ 2022'
        elif uid[:5] in ['10009']           :RAJU = ' √ 2023'
        else:shanto=''
...
╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░░╚═════╝░
   \033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m𝙄\033[1;95m𝙏\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
    ...
    \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
    ║  \x1b[97m\033[37;41m  ABDULLAH RAJU \033[0;m     \33[1;92m ║
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} RAJU.            {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H} ABDULLAH RAJU           {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H} rajuhasan0{N}       {H}  ║
      {M}║{M}[{H}•{M}] STATUS    : {H}FREE{P}     {N}  {H}      ║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H} ABDULLAH RAJU')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H} ABDULLAH RAJU')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART  CLONING {RED}(TCW)")
    ...
    if sh =='3':
       ...
       main()
        ...
        os.system('xdg-open https://github.com/rajuhasan0')
        main()
...
def _xxx_():
    ...
    print(f'{M}╔══[•] TOOL NAME : {H} ABDULLAH RAJU')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}SEX')
    print(f'{M}╚══[•] CODER NAME: {H} ABDULLAH RAJU')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART  RANDOM {RED}(TCW)")
    print(f"{M}╔══[{M}2{RED}] \033[1;31mSTART  X GMAIL {RED}(TCW)")
